            ...
            <div className="contentContainer">
                ...
                <div className="para">
                    <div className="para1">
                        ...
                        hobbylists and an eco-system of experts, teachers,
                        suppliers, classes, workshops, and places to practice,
                        participate or perform. Your hobby may be about visual
                        or perform arts, sports, games, gardening, model making,
                        cooking, indoor or outdoor activities...
                    </div>
                    <br />
                    <div className="para2">
                        If you are an expert or a seller, you can Add your
                        Listing and Promote yourself, your students, products,
                        services or events. Hop on you hobbyhorse and enjoy the
                        ride.
                    </div>
                </div>
                <div>
